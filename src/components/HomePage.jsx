...
const HomePage = () => {
  ...
  const services = [
    {
      ...
      title: 'Website',
      description:
        'Hadirkan bisnis Anda secara online dengan website profesional yang cepat, responsif, dan dirancang untuk mengonversi pengunjung menjadi pelanggan.',
    ...
    },
    {
      ...
      description:
        'Otomatisasi proses bisnis Anda dengan aplikasi berbasis web kustom yang scalable dan aman.',
    ...
    },
    {
      ...
      title: 'Mobile App',
      description:
        'Jangkau pelanggan di mana saja dengan aplikasi mobile native atau cross-platform yang user-friendly.',
      items: [
  ...
  const whyUsPoints = [
    {
      icon: <Code2 />,
      title: 'Clean Code',
      desc: 'Struktur kode yang rapi dan mudah di-maintain.',
    },
    {
      icon: <PenTool />,
      title: 'UI Modern',
      desc: 'Desain antarmuka terkini sesuai tren industri.',
    },
    {
      icon: <Layout />,
      title: 'Responsive',
      desc: 'Tampil sempurna di berbagai ukuran layar.',
    },
    {
      icon: <Globe />,
      title: 'SEO Friendly',
      desc: 'Struktur HTML semantik untuk pencarian Google.',
    },
    {
      icon: <Zap />,
      title: 'Fast Performance',
      desc: 'Optimasi kecepatan muat untuk pengalaman terbaik.',
    },
    {
      icon: <Layers />,
      title: 'Mudah Dikembangkan',
      desc: 'Arsitektur scalable untuk masa depan.',
    },
    {
      icon: <Rocket />,
      title: 'Siap Play Store',
      desc: 'Standar publikasi Google terpenuhi.',
    },
    {
      icon: <ShieldCheck />,
      title: 'Siap App Store',
      desc: 'Sesuai regulasi ketat Apple Store.',
    },
    {
      icon: <Wrench />,
      title: 'Maintenance',
      desc: 'Dukungan berkelanjutan pasca rilis.',
    },
  ]
  ...
  const workflowSteps = [
    {
      ...
      desc: 'Menganalisa masalah, tujuan, dan ekspektasi bisnis Anda.',
    },
    {
      num: '02',
      title: 'Perencanaan',
      desc: 'Menentukan arsitektur sistem, teknologi, dan timeline pengerjaan.',
    },
    {
      num: '03',
      title: 'Desain UI/UX',
      desc: 'Membuat wireframe dan desain antarmuka interaktif.',
    },
    {
      num: '04',
      title: 'Development',
      desc: 'Menerjemahkan desain ke dalam kode fungsional dan bersih.',
    },
    {
      num: '05',
      title: 'Testing',
      desc: 'Uji coba fungsionalitas, performa, dan keamanan sistem secara menyeluruh.',
    },
    {
      num: '06',
      title: 'Launching',
      desc: 'Proses deployment ke server produksi dan rilis aplikasi.',
    },
  ]
  ...
  return (
    <main className="overflow-hidden">
      ...
      <section
        id="home"
        className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 bg-background min-h-[90vh] flex items-center overflow-hidden"
      >
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            >
              <motion.div
                ...
                className="inline-block mb-4 px-3 py-1 rounded-full border border-border text-sm font-medium text-muted-foreground bg-secondary/50"
              >
                Agensi Pengembangan Digital
              </motion.div>
              <motion.h1 variants={staggerItem} className="mb-6">
                Bangun <span className="text-primary">Website & Aplikasi</span> Berkualitas untuk
                Bisnis Anda
              </motion.h1>
              <motion.p
                variants={staggerItem}
              ...
              >
                Kami merancang dan mengembangkan solusi digital modern yang responsif, cepat, dan
                berfokus pada pengalaman pengguna untuk mengakselerasi pertumbuhan bisnis Anda.
              </motion.p>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20">
            <div className="lg:col-span-4 relative">
              <motion.div {...fadeUpConfig} className="sticky top-32">
      ...
      <section id="portfolio" className="section-padding bg-background">
        <div className="container-custom">
          <motion.div {...fadeUpConfig} className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="mb-4">Eksplorasi Hasil Karya Kami</h2>
            <p className="text-muted-foreground text-lg">
              Kumpulan proyek yang telah kami selesaikan, menunjukkan dedikasi kami pada detail,
              performa, dan antarmuka yang intuitif.
            </p>
          </motion.div>
            ...
            <motion.div variants={staggerItem} className="group block h-full">
              <div className="rounded-2xl border border-border bg-secondary/30 p-10 h-full flex flex-col items-center justify-center text-center transition-all duration-300 hover:bg-secondary/60 hover:border-primary/20 premium-shadow hover:-translate-y-2">
                ...
                <p className="text-muted-foreground mb-8">
                  Lihat berbagai hasil desain dan pengembangan website kami.
                </p>
      ...
      <section id="why-us" className="section-padding bg-secondary/50 border-y border-border">
        <div className="container-custom">
          <motion.div {...fadeUpConfig} className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              Kami tidak sekadar membuat aplikasi. Kami merancang solusi teknologi yang kokoh dan
              berkelanjutan.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <motion.div {...fadeUpConfig} className="sticky top-32">
              ...
              <p className="text-muted-foreground text-lg mb-8">
                Kami menggunakan pendekatan agil dan iteratif. Setiap fase dirancang agar transparan
                dan memberikan dampak optimal.
              </p>
            </motion.div>
      ...
      >
        ...
        <div className="container-custom relative z-10">
          <motion.div {...fadeUpConfig} className="max-w-3xl mx-auto">
            <h2 className="mb-6 text-primary-foreground">
              Siap Membangun Website atau Aplikasi untuk Bisnis Anda?
            </h2>
            <p className="text-primary-foreground/80 text-lg mb-10 max-w-2xl mx-auto">
              Diskusikan kebutuhan teknis dan visi bisnis Anda. Kami bantu transformasikan ide
              tersebut menjadi produk nyata yang siap bersaing.
            </p>
            ...
            <Button
              ...
              asChild
            >
              <a href="https://link.wreative.com/wa" target="_blank" rel="noopener noreferrer">
