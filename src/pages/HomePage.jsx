  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
          ...
          <div className="container-custom relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
              ...
              >
                ...
                >
                  Kami merancang dan mengembangkan solusi digital modern yang
                  responsif, cepat, dan berfokus pada pengalaman pengguna untuk
                ...
                >
                  <Button
                    size="lg"
                    className="h-12 px-8 btn-micro-anim"
                    asChild
                  >
                    <a
                      href="#contact"
        ...
        <section
          id="services"
          className="section-padding bg-secondary/50 border-y border-border"
        >
              ...
              <div className="lg:col-span-4 relative">
                <motion.div {...fadeUpConfig} className="sticky top-32">
                  ...
                  <p className="text-muted-foreground mb-8 text-lg">
                    Solusi end-to-end dari perancangan awal hingga peluncuran
          ...
          <div className="container-custom">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg">
                Kumpulan proyek yang telah kami selesaikan, menunjukkan dedikasi
                kami pada detail, performa, dan antarmuka yang intuitif.
              </p>
            </motion.div>
            ...
            >
              <motion.div variants={staggerItem} className="group block h-full">
                <div className="rounded-2xl border border-border bg-secondary/30 p-10 h-full flex flex-col items-center justify-center text-center transition-all duration-300 hover:bg-secondary/60 hover:border-primary/20 premium-shadow hover:-translate-y-2">
                  ...
                  <Button
                    variant="outline"
                    className="w-full sm:w-auto btn-micro-anim"
                    asChild
                  >
                    <a
        ...
        >
          <div className="container-custom">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg">
                Kami tidak sekadar membuat aplikasi. Kami merancang solusi
                teknologi yang kokoh dan berkelanjutan.
              </p>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <motion.div {...fadeUpConfig} className="sticky top-32">
                ...
                <p className="text-muted-foreground text-lg mb-8">
                  Kami menggunakan pendekatan agil dan iteratif. Setiap fase
                  dirancang agar transparan dan memberikan dampak optimal.
                </p>
              </motion.div>
          ...
          <div className="container-custom relative z-10">
            <motion.div {...fadeUpConfig} className="max-w-3xl mx-auto">
              ...
              <p className="text-primary-foreground/80 text-lg mb-10 max-w-2xl mx-auto">
                Diskusikan kebutuhan teknis dan visi bisnis Anda. Kami bantu
                transformasikan ide tersebut menjadi produk nyata yang siap
                bersaing.
              </p>
              ...
              >
                <a
                  href="https://link.wreative.com/wa"
                  target="_blank"
                  rel="noopener noreferrer"
                >
